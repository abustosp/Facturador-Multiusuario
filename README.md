Archivos base para la Facturación Masiva en el Servicio de Comprobantes en Línea de AFIP mediante un BOT de UiPath (Versión Multiusuario)
#
...
<br/>
    ...
    ֎ Se deben completar mínimamente 2 Excels (uno con los datos de los clientes y otro con los datos de los comprobantes a emitir (uno por cada cliente))

        ֎ En el excel de "Listado Clientes" se tiene que hacer referencia al excel de comprobantes (en las columnas "Ubicación XLS" y "Nombre XLS")
